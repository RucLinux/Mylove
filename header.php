...
<div class="container app-container">
    <header class="site-header panel<?php echo xghome_classic_top_enhanced_enabled() ? ' hidden-xs' : ''; ?>">
    ...
    <?php if (xghome_classic_top_enhanced_enabled()) : ?>
        <div class="mobile-topbar visible-xs" id="mobileTopbar" role="banner">
            <button type="button" class="mobile-topbar-burger" id="mobileMenuBtn" aria-expanded="false" aria-controls="mobileDrawer">
                <span class="burger-line" aria-hidden="true"></span>
                <span class="burger-line" aria-hidden="true"></span>
                <span class="burger-line" aria-hidden="true"></span>
                <span class="mobile-topbar-burger-label">菜单</span>
            </button>
            <a class="mobile-topbar-brand" href="<?php echo esc_url(home_url('/')); ?>">
                <img class="mobile-topbar-homeicon" src="<?php echo esc_url(xghome_classic_icon_uri('home')); ?>" alt="" width="18" height="18" aria-hidden="true">
                <span class="mobile-topbar-title"><?php bloginfo('name'); ?></span>
            </a>
            <button type="button" class="mobile-topbar-iconbtn" id="mobileSearchBtn" aria-expanded="false" aria-controls="mobileSearchPanel" aria-label="搜索">
                <img src="<?php echo esc_url(xghome_classic_icon_uri('search')); ?>" alt="" width="20" height="20" aria-hidden="true">
            </button>
        </div>
        <div class="mobile-search-panel visible-xs" id="mobileSearchPanel" hidden>
            <div class="mobile-search-panel-inner panel">
                <button type="button" class="mobile-search-close" id="mobileSearchClose" aria-label="关闭搜索">×</button>
                <?php get_search_form(); ?>
            </div>
        </div>
        <div class="mobile-drawer-backdrop visible-xs" id="mobileDrawerBackdrop" hidden aria-hidden="true"></div>
        <aside class="mobile-drawer visible-xs" id="mobileDrawer" aria-hidden="true">
            <?php get_template_part('template-parts/mobile-drawer', 'nav'); ?>
        </aside>
